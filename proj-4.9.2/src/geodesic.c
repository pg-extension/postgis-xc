...
static THR_LOCAL  unsigned init = 0;
static THR_LOCAL  const int FALSE = 0;
static THR_LOCAL  const int TRUE = 1;
static THR_LOCAL  unsigned digits, maxit1, maxit2;
static THR_LOCAL  real epsilon, realmin, pi, degree, NaN,
