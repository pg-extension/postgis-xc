...
extern "C" Datum intersects3d(PG_FUNCTION_ARGS);
extern "C" Datum intersection(PG_FUNCTION_ARGS);
extern "C" Datum difference(PG_FUNCTION_ARGS);
extern "C" Datum geomunion(PG_FUNCTION_ARGS);
extern "C" Datum area(PG_FUNCTION_ARGS);
extern "C" Datum distance(PG_FUNCTION_ARGS);
extern "C" Datum distance3d(PG_FUNCTION_ARGS);

extern "C" Datum intersects3d_dwithin(PG_FUNCTION_ARGS);
...
/* Geometry Backend */
THR_LOCAL char* lwgeom_backend_name;
THR_LOCAL struct lwgeom_backend_definition* lwgeom_backend = &lwgeom_backends[0];
