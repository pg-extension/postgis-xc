...
extern "C" Datum sfcgal_distance3D(PG_FUNCTION_ARGS);
...
extern "C" Datum sfcgal_difference(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_difference3D(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_union(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_union3D(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_volume(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_extrude(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_straight_skeleton(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_approximate_medial_axis(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_is_planar(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_orientation(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_force_lhr(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_triangulate(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_tesselate(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_minkowski_sum(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_make_solid(PG_FUNCTION_ARGS);
extern "C" Datum sfcgal_is_solid(PG_FUNCTION_ARGS);
