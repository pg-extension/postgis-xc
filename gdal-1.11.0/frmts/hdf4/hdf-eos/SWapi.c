...
static THR_LOCAL int32 SWX1dcomb[512*3];
static THR_LOCAL int32 SWXSDcomb[512*5];
static THR_LOCAL char  SWXSDname[HDFE_NAMBUFSIZE];
static THR_LOCAL char  SWXSDdims[HDFE_DIMBUFSIZE];
...
** 23 June,1997  DaW
*/
static THR_LOCAL intn  timeflag = 0;
...
static THR_LOCAL struct swathStructure SWXSwath[NSWATH];
...
static THR_LOCAL struct swathRegion *SWXRegion[NSWATHREGN];
