...
static THR_LOCAL int32 GDXSDcomb[512*5];
static THR_LOCAL char  GDXSDname[HDFE_NAMBUFSIZE];
static THR_LOCAL char  GDXSDdims[HDFE_DIMBUFSIZE];
...
static THR_LOCAL struct gridStructure GDXGrid[NGRID];
...
static THR_LOCAL struct gridRegion *GDXRegion[NGRIDREGN];
