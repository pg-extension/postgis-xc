...
static THR_LOCAL intn  EHXmaxfilecount = 0;
static THR_LOCAL uint8 *EHXtypeTable = NULL;
static THR_LOCAL uint8 *EHXacsTable = NULL;
static THR_LOCAL int32 *EHXfidTable = NULL;
static THR_LOCAL int32 *EHXsdTable = NULL;
