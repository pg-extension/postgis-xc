...
THR_LOCAL double  MGRS_a = 6378137.0;    /* Semi-major axis of ellipsoid in meters */
THR_LOCAL double  MGRS_f = 1 / 298.257223563; /* Flattening of ellipsoid           */
THR_LOCAL  double MGRS_recpf = 298.257223563;
THR_LOCAL char   MGRS_Ellipsoid_Code[3] = {'W','E',0};
