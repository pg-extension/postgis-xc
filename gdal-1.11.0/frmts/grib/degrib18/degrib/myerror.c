...
static THR_LOCAL char *errBuffer = NULL; /* Stores the current built up message. */
static THR_LOCAL size_t errBuff_len = 0; /* Allocated length of errBuffer. */
...
static THR_LOCAL char *warnBuff = NULL; /* Stores the current built up message. */
static THR_LOCAL size_t warnBuffLen = 0; /* Allocated length of warnBuff. */
static THR_LOCAL sChar warnLevel = -1; /* Current warning level. */
static THR_LOCAL uChar warnOutType = 0; /* Output type as set in myWarnSet. */
static THR_LOCAL uChar warnDetail = 0; /* Detail level as set in myWarnSet. */
static THR_LOCAL uChar warnFileDetail = 0; /* Detail level as set in myWarnSet. */
static THR_LOCAL FILE *warnFP = NULL; /* Warn File as set in myWarnSet. */
